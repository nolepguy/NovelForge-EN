...
class ForeshadowService:
    ...
    def suggest(self, text: str) -> Dict[str, Any]:
        """
        Minimal heuristic:
        - Capture phrases following will/prepare/plan/swear to/must as pending goals
        - Capture nouns ending with sword/knife/ring/talisman/seal/pill/formation/armor/cauldron/pearl/mirror as suspected items
        - Roughly extract 2-4 character name candidates (excluding common function words)
        """
