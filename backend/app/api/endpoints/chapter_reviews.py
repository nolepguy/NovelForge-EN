...
@router.post(
    ...
    summary="Run card review (returns a review draft)",
)
...
@router.post(
    ...
    summary="Create or update a review result card",
)
...
@router.get(
    ...
    summary="Get the review result cards bound to a card",
)
...
@router.delete(
    ...
    summary="Delete a review result card",
)
