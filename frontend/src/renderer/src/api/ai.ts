...
// append_continuous_novel_directive (controls whether to append the "continuous novel body" directive)
...
export function generateContinuationStreaming(
  ...
  const endpoint = params.prompt_name === 'Inspiration Dialogue'
...
// Foreshadow suggestions (placeholder)
...
/**
 * Streaming chat dedicated to the inspiration assistant
 */
