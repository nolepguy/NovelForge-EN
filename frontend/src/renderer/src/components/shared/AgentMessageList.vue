  ...
  <div class="agent-message-list" ref="listEl">
    <div v-for="(msg, idx) in props.messages" :key="idx" :class="['msg-row', msg.role]">
      <div class="msg-stack">
                    ...
                    <div class="thinking-card">
                      <button class="thinking-trigger" type="button" @click="toggleThinkingItem(idx, timelineIndex)">
                        ...
                        <span class="thinking-title">
                          {{ isThinkingInProgress(idx, timelineIndex) ? t('misc.thinkingInProgress') : (isThinkingItemOpen(idx, timelineIndex) ? t('misc.thinkingProcess') : t('misc.thinkingDone')) }}
                        </span>
                  ...
                  <div class="tool-summary-card timeline-tool-card">
                    ...
                    <div v-if="timelineItem.tool.result !== undefined" class="tool-result-toggle-row">
                      <el-button text size="small" @click="toggleToolResult(idx, timelineIndex)">
                        {{ isToolResultOpen(idx, timelineIndex) ? t('misc.collapseResult') : t('misc.expandResult') }}
                      </el-button>
                    </div>
                    <pre
        ...
        >
          <el-tooltip :content="t('misc.copyReply')" placement="top">
            <el-button
              circle
              size="small"
              :icon="CopyDocument"
          ...
          <el-tooltip :content="t('misc.regenerate')" placement="top">
            <el-button
              circle
              size="small"
              :icon="RefreshRight"
          ...
          <el-tooltip :content="t('misc.deleteReply')" placement="top">
            <el-button
              circle
              size="small"
              :icon="Delete"
        ...
        <div
          ...
          class="assistant-actions"
        >
          <el-tooltip :content="t('misc.copyMessage')" placement="top">
            <el-button
              circle
              size="small"
              :icon="CopyDocument"
          ...
          <el-tooltip :content="t('misc.deleteMessage')" placement="top">
            <el-button
              circle
              size="small"
              :icon="Delete"
    ...
    <el-empty v-if="!props.messages.length" :description="props.emptyDescription || t('misc.agentEmptyPlaceholder')" />
  </div>
</template>
...
function formatToolStatus(toolItem: any): string {
  ...
  if (success === true) return t('misc.toolSuccess')
  if (success === false) return t('misc.toolFailed')
  return t('misc.toolExecuted')
}
